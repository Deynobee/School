...
#ctry = set(random.sample(list(range(countries_capital)), 1))
...
#    {"country": "United Kingdom", "capital":"Britain"}
#]
...
def countries_capital():
    ...
    random_country=random.sample(list(range(len(countries_capital))),1)
    ctry_select_random=countries_capital[random_country[0]]["name"]
    capital_select_random=countries_capital[random_country[0]]["capital"]
    print("--Country:Capital test----:")
    print(f"what is the capital city of {ctry_select_random}")
    count=0
    while count < 3:
       answer = input('Enter capital: ')
       if answer==countries_capital[random_country[0]]["capital"]:
           print(f"-----------------------------------------------")
           print(f"******GREAT********* {answer} is the capital of {ctry_select_random}")
           print(f"-----------------------------------------------")
           break
       else:
           count += 1
    print("You have exceeded attempts")
    print(f"-----------------------------------------------")
    print(f"{capital_select_random} is the capital of  {ctry_select_random} ")
    print(f"-----------------------------------------------")
